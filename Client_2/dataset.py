...
def prepare_dataset(batch_size, oversample=True):
    try:
        ...
        train_dataset = DatasetPreprocessing(csv_file='../Datasets/diabetes/client2.csv', transform=ToTensor(),
                                             oversample=oversample)
        val_dataset = DatasetPreprocessing(csv_file='../Datasets/diabetes/valid_c2.csv', transform=ToTensor())
