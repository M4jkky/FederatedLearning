...
def load_dataset():
    try:
        ...
        train_dataset = DatasetPreprocessing(csv_file='/Users/m4jkky/Desktop/school/3rd year/BAKPR/Clients/Datasets/heart/heart_client2.csv', transform=ToTensor())
        val_dataset = DatasetPreprocessing(csv_file='/Users/m4jkky/Desktop/school/3rd year/BAKPR/Clients/Datasets/heart/client2_valid.csv', transform=ToTensor())
