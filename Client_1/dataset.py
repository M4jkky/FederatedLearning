...
def load_dataset():
    try:
        ...
        train_dataset = DatasetPreprocessing(csv_file='/Users/m4jkky/Desktop/school/3rd year/BAKPR/Clients/Datasets/updated_client1', transform=ToTensor())
        val_dataset = DatasetPreprocessing(csv_file='/Users/m4jkky/Desktop/school/3rd year/BAKPR/Clients/Datasets/client1_valid.csv', transform=ToTensor())
